// Function to plot the race chart
//========================================
// Function raceChartData
...
function raceChartData(racedata) {
    ...
    am4core.ready(function() {
        ...
        var chart = am4core.create("chartdiv", am4charts.XYChart); // creating the chart instance
        ...
        var stepDuration = 4000;        // Chart playback speed
        ...
        var year = 2001;    // setting the starting year
        ...
        function nextYear() {
            ...
            if (year > 2020) {
                year = 2001;        // reset the year if the data ends
            }

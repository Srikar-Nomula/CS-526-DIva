...
data = pd.read_csv('C:\\Users\\Srikar Reddy\\Downloads\\Data.csv', usecols=use_cols, iterator=True, chunksize=100000)
...
# Visualisation for  Line chart integrated with  maps
# ---------------------------------------------------------
# function Chicago_district
# inputs: None
# Output: Data for Map to display
#-----------------------------------------------------------
...
UPLOAD_FOLDER = 'C:\\Users\\Srikar Reddy\\Downloads\\'
